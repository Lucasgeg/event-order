...
// Modèle configurable sans redéploiement de code : au cas où
// "gemini-3.6-flash" serait un jour retiré, changer la variable d'env suffit
// (cf. GEMINI_MODEL). Voir https://ai.google.dev/gemini-api/docs/models pour
...
export async function POST(request: Request) {
  try {
    ...
    const aiResponseContent = interaction.output_text;
