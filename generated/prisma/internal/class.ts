...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n}\n\nmodel Tenant {\n  id        String   @id @default(cuid())\n  name      String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  // Accès au panneau admin par PIN (docs/adr/0003-compte-unique-pin-admin.md)\n  pinCodeHash       String\n  pinFailedAttempts Int       @default(0)\n  pinLockedUntil    DateTime?\n  pinLockoutLevel   Int       @default(0)\n\n  categories Category[]\n  products   Product[]\n  orders     Order[]\n}\n\nmodel Category {\n  id            String        @id @default(cuid())\n  name          String\n  tenant        Tenant        @relation(fields: [tenantId], references: [id], onDelete: Cascade)\n  tenantId      String\n  subCategories SubCategory[]\n  products      Product[]\n}\n\nmodel SubCategory {\n  id         String    @id @default(cuid())\n  name       String\n  category   Category  @relation(fields: [categoryId], references: [id], onDelete: Cascade)\n  categoryId String\n  products   Product[]\n}\n\nmodel Product {\n  id            String       @id @default(cuid())\n  designation   String\n  price         Float\n  category      Category     @relation(fields: [categoryId], references: [id])\n  categoryId    String\n  subCategory   SubCategory? @relation(fields: [subCategoryId], references: [id])\n  subCategoryId String?\n  orderItems    OrderItem[]\n  tenant        Tenant       @relation(fields: [tenantId], references: [id], onDelete: Cascade)\n  tenantId      String\n  isActive      Boolean      @default(true)\n}\n\nmodel Order {\n  id         String      @id @default(cuid())\n  clientName String\n  pickupDate DateTime\n  createdAt  DateTime    @default(now())\n  items      OrderItem[]\n  tenant     Tenant      @relation(fields: [tenantId], references: [id], onDelete: Cascade)\n  tenantId   String\n}\n\nmodel OrderItem {\n  id          String  @id @default(cuid())\n  order       Order   @relation(fields: [orderId], references: [id], onDelete: Cascade)\n  orderId     String\n  product     Product @relation(fields: [productId], references: [id])\n  productId   String\n  quantity    Int\n  unitPrice   Float // prix du produit figé au moment de la commande\n  designation String // nom du produit figé au moment de la commande\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
